...
git clone https://github.com/tulip-org/kernel_xiaomi_sdm660 kernel -b xt
cd kernel
...
function zipping() {
    cd AnyKernel || exit 1
    zip -r9 Pitron-perf-tulip-${TANGGAL}.zip *
    cd ..
}
sticker
sendinfo
